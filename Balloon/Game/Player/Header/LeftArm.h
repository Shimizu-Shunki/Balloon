...
class LeftArm : public IComposite
{
public:
...
public:
	// コンストラクタ
	LeftArm(CollisionManager* collisionManger, IComponent* parent, const int balloonIndex, const DirectX::SimpleMath::Vector3& initialPosition, const float& initialAngle);
	// デストラクタ
	~LeftArm();
