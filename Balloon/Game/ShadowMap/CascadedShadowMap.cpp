...
void CascadedShadowMap::Initialize()
{
	...
	m_transform->SetLocalPosition(DirectX::SimpleMath::Vector3::UnitY * 5.0f + DirectX::SimpleMath::Vector3::UnitX * 0.5f);
	...
	m_lightProjectionMatrix = DirectX::SimpleMath::Matrix::CreateOrthographicOffCenter(
		-30.0f / 2.0f, 30.0f / 2.0f,   // 左・右
		-30.0f / 2.0f, 30.0f / 2.0f,   // 下・上
