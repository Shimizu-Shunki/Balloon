// ============================================
// 
// ファイル名: ResultButtonUI.h
// 概要: ResultButtonUI.cppのヘッダーファイル
// 
// 製作者 : 清水駿希
// 
// ============================================
...
class ResultButtonUI : public IObject
{
private:
...
public:
	...
	// コンストラクタ
	ResultButtonUI(ResultButtonUI::ButtonType buttonType , bool buttonActive);
	// デストラクタ
	~ResultButtonUI() = default;
