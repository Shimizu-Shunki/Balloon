// ============================================
// 
// ファイル名: StageNumberUI.h
// 概要: StageNumberUI.cppのヘッダーファイル
// 
// 製作者 : 清水駿希
// 
// ============================================
...
class StageNumberUI : public IObject
{
private:
...
public:
	...
	// コンストラクタ
	StageNumberUI(StageNumberID stageNumberId);
	// デストラクタ
	~StageNumberUI() = default;
